...
_$jscoverage['/return.js'].branchData['3'][1].init(34, 5, 'x > f');
function visit8_3_1(result) {
  _$jscoverage['/return.js'].branchData['3'][1].ranCondition(result);
  return result;
}_$jscoverage['/return.js'].branchData['2'][1].init(14, 5, 'x > 2');
...
(function() {
  ...
  return [visit7_2_1(x > 2)];
  _$jscoverage['/return.js'].lineData[3]++;
  return visit8_3_1(x > f) ? 1 : 2;
});
